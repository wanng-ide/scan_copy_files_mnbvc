...
def scan_files(source_folder, keywords):
    files = []
...
def copy_random_files(source_folder, destination_folder, n, keywords):
    # 检查源文件夹是否存在
    ...
    files = scan_files(source_folder, keywords)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--keywords', nargs='+', required=True, help='需要筛选的关键词')

    args = parser.parse_args()

    copy_random_files(args.source_folder, args.destination_folder, args.n, args.keywords)
